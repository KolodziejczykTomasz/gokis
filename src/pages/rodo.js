    ...
    <Wrapper>
      ...
      <div>
        <p>
          ...
          przetwarzane są w sposób zgodny z przepisami Rozporządzenia Parlamentu
          Europejskiego i Rady (UE) 2016/679 i Ustawy o Ochronie danych
          osobowych Dz. U. 2018 poz. 1000 regulującymi przetwarzanie danych
          osobowych. Zbiory zgromadzonych danych osobowych Użytkowników w
          serwisie www.gokispilnik.pl podlegają właściwej ochronie, zgodnie z
          ww. przepisami. Pełen dostęp do baz danych posiadają jedynie
          uprawnione osoby zatrudnione w Gminnym Ośrodku Kultury i Sportu
          wyznaczone przez Administratora.
        </p>
        <p>
          Administratorem danych osobowych jest Gminny Ośrodek Kultury i Sportu,
          z siedzibą w Pilnik 2, 11-100 Lidzbark Warmiński.
        </p>
        <p>
        ...
        <p>
          ...
          odczytać przy każdorazowym połączeniu się z tego urządzenia końcowego.
        </p>
        <p>
        ...
        <p>
          ...
          Użytkownika na zapis cookies lub ich wykorzystanie, po ich akceptacji
          za pośrednictwem portalu www.gokispilnik.pl.
        </p>
        <p>
          ...
          <ul>
            ...
            <li>
              oznaczenia, że wypełniona została formularza kontakt i formularza
              do przesyłania przypisów.
            </li>
          </ul>
        </p>
        <p>
          ...
          Gminnego Ośrodka Kultury i Sportu w Pilniku, Pilnik 2 11-100 Lidzbark
          Warmiński.
        </p>
        <p>
          <ul>
